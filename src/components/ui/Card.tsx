...
export function Card({ title, desc, children, className = "" }: CardProps) {
  return (
    <div className={`rounded-3xl border border-neutral-200 bg-white/70 p-5 shadow-[0_2px_30px_rgba(0,0,0,0.05)] backdrop-blur dark:border-neutral-800 dark:bg-black/30 ${className}`}>
